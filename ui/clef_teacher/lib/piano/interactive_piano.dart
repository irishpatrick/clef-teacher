          ...
          return _MaybeScrollbar(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final naturals = _noteGroups[index].where(
                  (a) => a.accidental == Accidental.None,
                );
                final accidentals = _noteGroups[index].where(
                  (a) => a.accidental != Accidental.None,
                );
                ...
                return Stack(
                  children: [
                    ...
                    Positioned(
                      top: 0.0,
                      bottom: 0.0,
                      left: _lastKeyWidth / 2.0 + (_lastKeyWidth * 0.02),
